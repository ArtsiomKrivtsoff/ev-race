...
<link rel="stylesheet" href="/CSS/location-page.css?v=51">
...
${renderPhotoUploadModal()}
${renderCommunitySignalsModal()}
<script src="/JS/community-signals.js?v=11"></script>
<script src="/JS/photos-gallery.js?v=3"></script>
<script src="/JS/photos-upload.js?v=7"></script>
<script src="/JS/location-page.js?v=15"></script>
